...
const PostCard = ({ post }) => {
  return (
    ...
    overflow-hidden rounded-lg w-full sm:w-[330px] border border-gray-400'>
        ...
        duration-300 hover:scale-105 bg-gray-200' />
        </Link>
       ...
       <div className='p-3 flex flex-col gap-2'>
        ...
        <Link to={`/post/${post.slug}`} className='border border-slate-500 
        text-slate-700 hover:bg-blue-500 hover:text-white text-center py-2 rounded-md mt-auto'>
        Read Article
        </Link>
       </div>
