...
focus-visible:ring-offset-0" onChange={(e) => setFormData({...formData, title: e.target.value})} 
...
>{imageUploading ? "Uploading..." : "Upload Image"}</Button>
  </div>
...
{formData.image && (
  ...
  <ReactQuill theme="snow" placeholder='Write something here...' 
  className='h-72 mb-12' required  onChange={(value) => {setFormData({...formData , content:value})}} value={formData.content}/>
