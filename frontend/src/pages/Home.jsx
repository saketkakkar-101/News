             ...
             <p>
              ...
              <Link to={"/search"}>
                 <Button className="bg-yellow-400 hover:bg-yellow-600
                  text-black py-3 px-6 rounded-full font-semibold shadow-lg flex items-center gap-2 w-fit"
           ...
           <div className='max-w-7xl mx-auto text-center'>
              <h2 className='text-4xl font-bold mb-8 text-gray-800'>
               ...
               <div className='grid grid-cols-1 md:grid-cols-3 gap-8'>
                  <FeatureCard title={"Diverse Content"} 
        ...
        <div className='max-w-6xl mx-auto p-3 flex flex-col gap-8 py-7'>
          {posts && posts.length > 0 && (
            <div className='flex flex-col gap-6'>
               ...
               <Link to={"/search"}
           className='text-lg hover:underline text-center font-semibold'>View all news</Link>
...
const FeatureCard = ({title , description, icon}) => {
  ...
  return (
  <div className='p-6 bg-gray-100 shadow-md hover:shadow-lg rounded-lg
