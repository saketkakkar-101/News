...
const res = await fetch(`https://news-phi-rose-76.vercel.app/api/post/getposts?slug=${postSlug}`);
...
const res = await fetch(`https://news-phi-rose-76.vercel.app/api/post/getposts?limit=3`);
...
if (loading) {
    return <div className='flex justify-center items-center min-h-screen'>
        <img src="https:cdn-icons-png.flaticon.com/128/39/39979.png" 
        alt="loading"
