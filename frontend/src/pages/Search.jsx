        ...
        <form className="flex flex-col gap-6" onSubmit={handleSubmit}>
         ...
         <Select onValueChange={(value) => 
              ...
              {/* submit button */}
                ...
                <Button type="submit" className="bg-red-600 text-white py-2 px-4 
                roundd-md shadow-lg">Apply Filters</Button>

        </form>
      </aside>

      <div className="w-full">
        <h1 className="text-2xl font-semibold text-slate-700 p-3 mt-5">News Articles:</h1>
        ...
        <div className="p-7 flex flex-wrap gap-4">
           ...
           {!loading
            ...
            {showMore && (
              ...
              className="text-slate-800 text-lg hover:underline p-7 w-full">Show More</button>
            )}
        </div>
