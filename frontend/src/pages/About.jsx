          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-8 items-center'>
           ...
           <div>
            ...
            <div className='relative'>
               <img src="https://images.pexels.com/photos/723072/pexels-photo-723072.jpeg?auto=compress&cs=tinysrgb&w=600"
        ...
        <div className='grid grid-cols-1 md:grid-cols-3 gap-8 max-w-6xl mx-auto'>
           <div className='text-center'>
              <img src="https://cdn-icons-png.flaticon.com/128/3135/3135715.png"
               ...
               />
               <h3 className='text-xl font-semibold text-gray-700'>Jaime Lannister</h3>
           ...
           <div className='text-center'>
              <img src="https://cdn-icons-png.flaticon.com/128/4140/4140037.png"
               ...
               className='w-32 h-32 rounded-full mx-auto mb-4'
               />
               <h3 className='text-xl font-semibold text-gray-700'>Cersei Lannister</h3>
